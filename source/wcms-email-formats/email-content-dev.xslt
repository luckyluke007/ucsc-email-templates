          ...
          <xsl:choose>
            <xsl:when test="image != ''">
              <table align="right" border="0" cellpadding="0" cellspacing="0" class="mWidth mCenter" summary="{image-alt}" width="295">
                <tbody>
                  <tr>
                    <td class="mWidth spacing-left mCenter large-spacing-top">
                      <img alt="{image-alt}" class="mFullImage" src="{image/path}" width="295"/>
                    </td>
                  </tr>
                  <tr>
                    <td class="mWidth spacing-left xlarge-spacing-bottom">
        ...
        <xsl:variable name="image-optional-url">
          <xsl:choose>
            <xsl:when test="asset-link/link != '' or url != ''">
              <a href="{asset-link/link}{url}{$trackingURL}">
                      ...
                      <xsl:if test="image/name != ''">
                        <tr>
                          <td class="mWidth large-spacing-right">
                            <xsl:copy-of select="$three-image-optional-url"/>
                          </td>
                        </tr>
                      </xsl:if>
                      <tr>
